...
public class EstacionamentoMapFragment extends SherlockMapFragment{
	
	
	private static final int REQUEST_PRESTA_SERVICO = 1;
	 static final String TAG = EstacionamentoMapFragment.class.getSimpleName();
	...
	private Runnable runner = new Runnable() {
	 ...
	 public static EstacionamentoMapFragment newInstance(int position,String title) {
		 EstacionamentoMapFragment fragment = new EstacionamentoMapFragment();
