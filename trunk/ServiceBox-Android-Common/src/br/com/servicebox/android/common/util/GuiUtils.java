...
package br.com.servicebox.android.common.util;
...
public class GuiUtils {
    ...
    /**
     * Validar dados de texto básicos (seja nulo ou vazio) e mostrar apropriado 
     * "Por favor especificar primeira" mensagem se ela é inválida
     * 
     * @param values
     * @param titles
     * @param activity
