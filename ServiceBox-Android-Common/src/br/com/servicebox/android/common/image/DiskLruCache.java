...
public class DiskLruCache {
    ...
    public static DiskLruCache openCache(Context context, File cacheDir, long maxByteSize,
        ...
        /**
        TrackerUtils.trackBackgroundEvent("unsuccessfullDiskCacheCreationForParameters",
                        CommonUtils.format("path: %1$s;isDirectory: %2$b; canWrite: %3$b; usableSpace: %4$d; maxByteSize: %5$d",
