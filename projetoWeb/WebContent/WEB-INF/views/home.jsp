...
<head>
	...
	<link type="text/css" href="<c:url value="/resources/bootstrap-responsive.css"/>" rel="stylesheet">
	<link type="text/css" href="<c:url value="/resources/charisma-app.css"/>" rel="stylesheet">
	<link type="text/css" href="<c:url value="/resources/jquery-ui-1.8.21.custom.css"/>" rel="stylesheet">
	<link type="text/css" href='<c:url value="/resources/fullcalendar.css"/> css/' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/fullcalendar.print.css"/>' rel='stylesheet'  media='print'>
	<link type="text/css" href='<c:url value="/resources/chosen.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/uniform.default.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/colorbox.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/jquery.cleditor.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/jquery.noty.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/noty_theme_default.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/elfinder.min.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/elfinder.theme.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/jquery.iphone.toggle.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/opa-icons.css"/>' rel='stylesheet'>
	<link type="text/css" href='<c:url value="/resources/uploadify.css"/>' rel='stylesheet'>
...
<body>
	...
	<script src="<c:url value="/resources/js/js/bootstrap-transition.js"/>"></script>
	...
	<!-- tour library -->
	<script src="<c:url value="/resources/js/bootstrap-tour.js"/>"></script>
